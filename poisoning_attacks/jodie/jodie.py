...
def main():
    ...
    parser.add_argument('--output',type=str, default = 'jodie_output.txt', help = "Output file path")
    ...
    for iteration in range(3):
        perturbed_users = []
        model = JODIE(embedding_dim, num_features, num_users, num_items).to(device)
